    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {toPersianDigits(pagination.total)} سفارش
        </p>
      </div>
        ...
        <Table>
          ...
          <TableBody>
            ...
            {orders.map((o) => {
              ...
              return (
                <TableRow key={o.id}>
                  <TableCell className="font-bold text-navy" dir="ltr">
                    {toPersianDigits(o.code)}
                  </TableCell>
                  <TableCell>
      ...
      <PaginationControls
        ...
        itemLabel="سفارش"
        hrefForPage={(p) => buildPagedHref("/admin/orders", raw, p)}
      />
    </div>
  );
}
