const DEFAULTS = {
  ...
  experience: "زیبایی و شکوهی که شایسته شماست",
  slogan: "با افتخار، برترین و به‌روزترین طراحی‌های طلا و جواهر را در محیطی امن و مطمئن به شما همراهان گرامی معرفی می‌کنیم.",
};
